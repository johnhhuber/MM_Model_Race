...
bayesianSetup <- createBayesianSetup(ll_age_cmp, lower = params_lower, upper = params_upper)
...
# write to file 
write.csv(post, file = paste('../output/mcmc_no_age/posterior_', chain_id, '.csv', sep = ''), row.names = F)
