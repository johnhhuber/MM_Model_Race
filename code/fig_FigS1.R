...
mtext(side = 3, line = 0, 'Non-Hispanic White Men', font = 2, col = palette[1])
...
axis(side = 1, at = seq(from = -1, to = 10, by = 1), labels = seq(from = -1, to = 10, by = 1))
axis(side = 2, las = 1, at = seq(from = 0, to = 1, by = 0.2), labels = seq(from = 0, to = 100, by = 20))
mtext(side = 3, line = 0, 'Non-Hispanic Black Men', font = 2, col = palette[3])
...
mtext(side = 2, line = 2.3, 'Survival (%)')
mtext(side = 3, line = 0, 'Non-Hispanic White Women', font = 2, col = palette[2])
...
axis(side = 2, las = 1, at = seq(from = 0, to = 1, by = 0.2), labels = seq(from = 0, to = 100, by = 20))
mtext(side = 1, line = 2.3, 'Years since Diagnosis')
mtext(side = 3, line = 0, 'Non-Hispanic Black Women', font = 2, col = palette[4])
