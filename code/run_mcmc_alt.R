...
bayesianSetup <- createBayesianSetup(ll_alt_cmp, lower = params_lower, upper = params_upper)
...
# write to file 
write.csv(post, file = paste('../output/mcmc_alt/posterior_', chain_id, '.csv', sep = ''), row.names = F)
